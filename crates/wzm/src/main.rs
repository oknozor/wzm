static POSSIBLE_BACKENDS: &[&str] = &[
    #[cfg(feature = "winit")]
    "--winit : Run wzm as a X11 or Wayland client using winit.",
    #[cfg(feature = "udev")]
    "--tty-udev : Run wzm as a tty udev client (requires root if without logind).",
    #[cfg(feature = "x11")]
    "--x11 : Run wzm as an X11 client.",
];
