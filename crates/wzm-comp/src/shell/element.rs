...
use smithay::input::pointer::{
    AxisFrame, ButtonEvent, GestureHoldBeginEvent, GestureHoldEndEvent, GesturePinchBeginEvent, GesturePinchEndEvent, GesturePinchUpdateEvent, GestureSwipeBeginEvent, GestureSwipeEndEvent, GestureSwipeUpdateEvent, MotionEvent, PointerTarget, RelativeMotionEvent
};
...
impl<Backend: crate::state::Backend> PointerTarget<WzmState<Backend>> for SSD {
    fn enter(
        &self,
        _seat: &Seat<WzmState<Backend>>,
        _data: &mut WzmState<Backend>,
        event: &MotionEvent,
    ) {
    ...
    fn button(
        &self,
        seat: &Seat<WzmState<Backend>>,
        data: &mut WzmState<Backend>,
        event: &ButtonEvent,
    ) {
        let mut state = self.0.decoration_state();
        if state.is_ssd {
    ...
    fn frame(&self, _seat: &Seat<WzmState<Backend>>, _data: &mut WzmState<Backend>) {}
    fn leave(
        &self,
        _seat: &Seat<WzmState<Backend>>,
        _data: &mut WzmState<Backend>,
...
impl<Backend: crate::state::Backend> TouchTarget<WzmState<Backend>> for SSD {
    fn down(
        &self,
        seat: &Seat<WzmState<Backend>>,
        data: &mut WzmState<Backend>,
    ...
    fn frame(&self, _seat: &Seat<WzmState<Backend>>, _data: &mut WzmState<Backend>, _seq: Serial) {}

    fn cancel(&self, _seat: &Seat<WzmState<Backend>>, _data: &mut WzmState<Backend>, _seq: Serial) {
    }
