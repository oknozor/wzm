...
use smithay::wayland::selection::data_device::{
    clear_data_device_selection, current_data_device_selection_userdata, request_data_device_client_selection, set_data_device_selection
};
...
impl<BackendData: Backend> XWaylandShellHandler for WzmState<BackendData> {
    fn xwayland_shell_state(&mut self) -> &mut XWaylandShellState {
        &mut self.xwayland_shell_state
    }
}

impl<BackendData: Backend> XwmHandler for WzmState<BackendData> {
    ...
    fn resize_request(
        ...
        // luckily wzm only supports one seat anyway...
